...
jQuery.fn.timelinr = function (options) {
	...
	settings = jQuery.extend({
		...
		prevButton: 				'#prev_t',			// value: any HTML tag or #id, default to #prev
		nextButton: 				'#next_t',			// value: any HTML tag or #id, default to #next
	...
	var howManyDates, howManyIssues, currentDate, currentIssue, widthContainer, heightContainer, widthIssues, heightIssues, widthIssue, heightIssue, widthDates, heightDates, widthDate, heightDate, defaultPositionDates;
	this.resize = function (resizeOnly) {
